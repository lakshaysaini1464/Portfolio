          ...
          <div className="bg-gray-900 rounded-xl shadow-2xl w-full max-w-xl mx-auto overflow-hidden relative">
            ...
            <div className="flex flex-col items-center px-4">
              <img
                ...
                className="w-full max-h-[40vh] object-contain rounded-xl shadow-xl"
              />
              <div className="p-4 max-h-[60vh] overflow-y-auto w-full">
                ...
                <a
                  ...
                  className="block bg-gray-800 hover:bg-purple-800 text-gray-300 px-4 py-2 rounded-xl text-center text-sm font-semibold w-full"
                >
                  View Repository
                </a>
              </div>
